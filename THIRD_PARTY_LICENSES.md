...
This file records third-party content that is bundled, adapted, generated from, or used as a reference by LC Chinese Project. LC Chinese Project itself is distributed under the MIT License; see `LICENSE`.
...
- License: MIT
- Usage: Portions of the Simplified Chinese translation catalog and selected localization assets were imported, reviewed, and maintained in this project. Runtime loading and replacement logic is implemented by LC Chinese Project.
...
- License: MIT
- Usage: FontPatcher-style runtime font bundle loading, matching, and fallback injection behavior is partially adapted in `EmbeddedFontPatcherService` and the `fonts/fontpatcher/default/` resources.
...
- License: MIT
- Usage: Reviewed as a conceptual reference for localization asset workflows. LC Chinese Project does not bundle, reference, copy, or require GameTranslator runtime code.
